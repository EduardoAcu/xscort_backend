    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_nacimiento', models.DateField(blank=True, help_text='Fecha de nacimiento (debe ser mayor de 18 años)', null=True)),
                ...
                ('foto_documento', models.ImageField(blank=True, null=True, upload_to='documentos/', validators=[usuarios.models.validate_documento])),
                ('selfie_con_documento', models.ImageField(blank=True, null=True, upload_to='selfies/', validators=[usuarios.models.validate_selfie])),
